...
//val sharkUnreadMessages = sharkInitialMessages.filter { it.author != "me" }

val sharkExampleUiState = SharkConversationUiState(
    initialMessages = SharkDataHelper.reloadMessages("sn://universal"),
    channelUri = "sn://universal"
)
